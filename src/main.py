...
class FileLog(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self.fileTableFrame, text="File", anchor="w", background="#FAF9F6", wraplength=50).grid(row=0, column=1)
        tk.Label(self.fileTableFrame, text="Classification", anchor="w", background="#FAF9F6").grid(row=0, column=2)
        tk.Label(self.fileTableFrame, text="Notes", anchor="w", background="#FAF9F6", wraplength=50).grid(row=0, column=3)
...
class Controller(tk.Tk):
    ...
    def BeginInvestigation(self):
        ...
        print(f"framesssssssssssssssssssss == {self.frames}")
